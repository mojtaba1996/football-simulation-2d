...
FRICTION = 5  # 5
PLAYER_SPEED = [int(PLAYER_RADIUS // 2), PLAYER_RADIUS, PLAYER_RADIUS + BALL_RADIUS]  # [5, 10, 18]
...
''' rules '''
ALLOWED_PLAYERS_IN_PENALTY_AREA_NUMBER = 5
ALLOWED_PLAYERS_AROUND_BALL_NUMBER = 2
ALLOWED_PLAYERS_AROUND_BALL_RADIUS = 2 * (PLAYER_RADIUS + BALL_RADIUS)  # 36
